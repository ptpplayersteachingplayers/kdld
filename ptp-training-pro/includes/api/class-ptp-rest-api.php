...
class PTP_REST_API {
    ...
    public function submit_application($request) {
        ...
        $data = array(
            ...
            'experience_summary' => sanitize_textarea_field($request->get_param('experience_summary')),
            'playing_background' => sanitize_textarea_field($request->get_param('playing_background')),
            ...
            'intro_video_url' => esc_url_raw($request->get_param('intro_video_url')),
            'instagram_handle' => sanitize_text_field($request->get_param('instagram')),
            'referral_source' => sanitize_text_field($request->get_param('referral_source')),
    ...
    public function schedule_session($request) {
        ...
        $user_id = get_current_user_id();
        if ($session->customer_id != $user_id && $session->trainer_id != PTP_Database::get_trainer_by_user($user_id)->id) {
