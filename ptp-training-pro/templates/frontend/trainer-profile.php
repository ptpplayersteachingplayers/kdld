...
if (!$trainer) {
    echo '<div class="ptp-error"><h2>Trainer Not Found</h2><p>The trainer you are looking for does not exist.</p><a href="' . home_url('/private-training/') . '" class="ptp-btn">Browse All Trainers</a></div>';
    return;
}
