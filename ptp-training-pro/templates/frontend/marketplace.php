...
<div class="ptp-marketplace" id="ptpMarketplace">
    ...
    <!-- Hero Section -->
    <section class="ptp-mp-hero" style="background-image: linear-gradient(rgba(14, 15, 17, 0.7), rgba(14, 15, 17, 0.8)), url('https://ptpsummercamps.com/wp-content/uploads/2025/12/BG7A1899.jpg');">
        <div class="ptp-mp-hero-content">
            <h1>Find Your Perfect Soccer Trainer</h1>
            <p>Train 1-on-1 with current MLS players and D1 college athletes in your area</p>
            
            <div class="ptp-mp-search-bar">
                <div class="ptp-mp-search-location">
                ...
                <button type="button" id="searchTrainers" class="ptp-btn ptp-btn-primary">Find Trainers</button>
            </div>
        </div>
    </section>
